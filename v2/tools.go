...
const (
	randomStringSource = "abcdefghijklmnopqrstuvwzyzABCDEFGHIJKLMNOPQRSTUVWZYX0123456789_+"
)
...
// DownloadStaticFile donwloads a file, and tries to force the browser to avoid displaying it
...
// ErrorJSON takes an error, and optionally a status codew, and gernrates and JSON response error message
...
func (t *Tools) PushJSONToRemote(uri string, data interface{}, client ...*http.Client) (*http.Response, int, error) {
	...
	// build the redquest and set the header
