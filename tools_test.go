...
func TestTools_UploadOneFile(t *testing.T) {
	...
	if _, err := os.Stat(fmt.Sprintf("./testdata/uploads/%s", uploadedFile.NewFileName)); os.IsNotExist(err) {
		t.Errorf("%s: expected file to exist: %s", "One file", err.Error())
	}
...
func TestTools_Slugify(t *testing.T) {
	...
	var slugTests = []struct {
		...
		{name: "japanesse string", s: "こんにちは世界", expected: "", errorExpected: true},
		{name: "japanesse and roman string", s: "hello worldこんにちは世界", expected: "hello-world", errorExpected: false},
	}
...
func TestTools_DownloadStaticFile(t *testing.T) {
	...
	testTool.DownloadStaticFile(rr, req, "./testdata", "pic.png", "puppy.jpg")
...
func TestTools_ReadJSON(t *testing.T) {
	...
	var jsonTests = []struct {
		...
		{name: "missing field name", json: `{: "1"}`, errorExpected: true, maxSize: 1024, allowUnknown: true},
